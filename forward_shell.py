...
class ForwardShell:
    ...
    def __init__(self):
        ...
        self.help_options = {'enum suid': 'FileSystem SUID Privileges Enumeration', 'help': 'Show this help'}
    ...
    def run(self):
        ...
        while True:
            ...
            if command.strip() == "exit":
                self.is_pseudo_terminal = False
                print(colored(f"\n[!] Se ha salido de la Pseude-terminal", 'red'))
                self.clear_stdout()
                continue
